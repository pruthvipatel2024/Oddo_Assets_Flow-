...
export function NotificationPanel({ open, onClose }: NotificationPanelProps) {
  ...
  return (
    <>
      ...
      <div className="absolute right-0 mt-2 w-80 sm:w-96 rounded-lg border border-border bg-card shadow-lg z-50 overflow-hidden divide-y divide-border/60 animate-in fade-in duration-150 select-none">
        ...
        <div className="max-h-[300px] overflow-y-auto divide-y divide-border/40 select-text">
          {notifications.length === 0 ? (
            <div className="py-8 flex flex-col items-center justify-center text-muted-foreground select-none">
