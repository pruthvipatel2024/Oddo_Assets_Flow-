  ...
  const navigation = [
    {
      ...
      items: [
        ...
        { name: "Analytics & Reports", href: "/reports", icon: FileBarChart2, permission: "report.export" },
      ],
    },
    {
      ...
      items: [
        ...
        { name: "Custody & Transfers", href: "/allocations", icon: ArrowLeftRight, permission: "asset.allocate" },
    ...
    },
    {
      group: "Management",
      items: [
        { name: "ERP Administration", href: "/organization", icon: Building2, permission: "organization.manage" },
        { name: "Auditing & Compliance", href: "/audits", icon: ShieldCheck, permission: "audit.create" },
      ],
    },
    {
      group: "System",
  ...
  const filteredNavigation = navigation
    .map((group) => {
      const items = group.items.filter((item) => {
        ...
        return hasPermission(roleId, item.permission as Permission)
      })
      return { ...group, items }
    })
                ...
                <>
                  ...
                  <div className="absolute right-0 mt-2 w-56 rounded-md border border-border bg-card shadow-lg z-40 py-1 divide-y divide-border/60">
                    <div className="px-4 py-2.5">
                      <span className="block text-xs font-semibold text-foreground/90 truncate">{user?.fullName}</span>
